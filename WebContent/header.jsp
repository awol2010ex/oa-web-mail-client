...
<div id="header" style="display:none;">
	...
	<ul class="nav">
		<li class="active" id="navhome"  style='display:none'><a href="javascript:layoutHome();"><span><img alt="" src="images/top-home.png"/></span><i18n:message key="home"/></a></li>
...
<!--	<li id="navwebdisk"><a href="javascript:layoutWebdisk();"><span><img alt="" src="images/top-disk.png"/></span><i18n:message key="web.disk"/></a></li> --> 
		<li id="navchat"   style='display:none'><a href="javascript:layoutChat();"><span><img alt="" src="images/top-chat.png"/></span><i18n:message key="chat"/></a></li>
	</ul>
</div>
